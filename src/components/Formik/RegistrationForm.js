...
function RegistrationForm() {
  ...
  const validationSchema = Yup.object({
    name: Yup.string()
      .min(2, "Minmum 3 char")
      .max(10, "very longer,please maximum 10 char")
      .required("Please input your name!"),
    phoneNo: Yup.string()
      .typeError("Only Number Allowed")
      .max(10, "Mobile Number is must be 10 characters")
    ...
    address: Yup.string()
      .min(8, "minmum 8 char requird")
      .max(20, "20 Char required")
        ...
        {(formik) => {
          return (
            <Form className="formtag">
              ...
              <useToastContainer autoClose={1500} />
