...
function FormikContainer() {
    ...
    return (
        <Formik initialValues={initailValues} validationSchema={validationSchema} onSubmit={onSubmit}>
            {
                formik => <Form>
                    <FormikControl control='input' label='Email:-' name='email' placeholder='Enter a email...' /><br />
                    <FormikControl control='textarea' label='Description:-' name='descripton' placeholder='Enter a description...' />
                    <FormikControl control='select' label='Select a topic:-' name='selectOption' options={dropdrownOptions} />
                    <FormikControl control='radio' label='Radio topic:-' name='radioOption' options={radioOption} />
                    <FormikControl control='checkbox' label='checkbox topic:-' name='checkboxOption' options={checkboxOption} />
