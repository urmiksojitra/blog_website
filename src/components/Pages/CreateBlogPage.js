...
function CreateBlogPage() {
    ...
    const changeHandler = (e) => {
        setBlog({ ...blog, [e.target.name]: e.target.value, user_id: token, user_name: user })
    }
    ...
    return (
        <div>
            ...
            > <form>
                    ...
                    <input onChange={changeHandler} name="blogTitle"></input><br /><br />
                    <label>Description:-</label><br />
                    <input onChange={changeHandler} name="desc"></input><br /><br />
